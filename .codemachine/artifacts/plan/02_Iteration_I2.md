...
*   **Task 2.2: Implement AjWorkflow (Temporal Workflow)**
    ...
    *   **Inputs:** Section 3.7 (Workflow & Activity Execution Flow), temporalio-sdk Ruby workflow documentation, payload structure from I1.T5, configuration from I1.T3
    *   **Input Files:**
...
*   **Task 2.3: Implement AjRunnerActivity (Temporal Activity)**
    ...
    *   **Agent Type Hint:** `BackendAgent`
    *   **Inputs:** Section 3.7 (Workflow & Activity Execution Flow), Section 3.7 (Error Handling), temporalio-sdk Ruby activity documentation, Payload module from I1.T5, RetryMapper from I1.T6
    *   **Input Files:**
        - `lib/activejob/temporal/payload.rb`
